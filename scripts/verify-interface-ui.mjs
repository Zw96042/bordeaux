...
const output = process.env.BORDEAUX_INTERFACE_UI_OUTPUT ? path.resolve(process.env.BORDEAUX_INTERFACE_UI_OUTPUT) : await fs.mkdtemp(path.join(os.tmpdir(), 'bordeaux-interface-ui-'));
