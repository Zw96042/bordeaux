...
// Includes the in-app update dialog, release notes, progress, and recovery controls.
// This flow adds about 6 KiB; retain less than 1 KiB of application headroom.
const APPLICATION_JAVASCRIPT_BUDGET_BYTES = 513 * 1024;
