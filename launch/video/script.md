# 37.5-second launch film script

The supplied draft has a silent audio track. Record the voiceover below, then replace or extend the code-built product walkthrough with the real captures in `shot-list.csv`.

| Time | Voiceover | Picture / on-screen text |
| --- | --- | --- |
| 00:00–00:04 | Drawing a path is easy. Knowing the run is harder. | Title card: **Draw the path. Know the run.** |
| 00:04–00:06.5 | Bordeaux keeps the constraints in view. | Plan chapter card. |
| 00:06.5–00:13 | Shape the spline. Set headings, events, and local limits right where the field demands them. | Plan workspace; playback marker begins following the authored route. |
...
**Voiceover:** “Draw the path. Know the run. Bordeaux beta.”

Picture: tipping glass → pour becomes route → end-card lockup.
