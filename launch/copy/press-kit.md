...
- Maintained language target: LabVIEW 17
...
- LabVIEW boundary: installs managed support after preview; does not edit `RobotContainer`; does not deploy
- Source: https://github.com/Zw96042/bordeaux

## Suggested attribution

“Bordeaux” with a capital B. Use “FRC path and autonomous routine editor” on first reference. Do not describe the bounded planner as globally optimal, the LabVIEW integration as deployment, or agent proposals as self-applying.
